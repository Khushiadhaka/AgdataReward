...
namespace UserRewardSystem.Infrastructure.Repository
{
    ...
    public class InMemoryEventRepository : IEventRepository
    {
        ...
        public Task<IEnumerable<Event>> GetAllAsync() => Task.FromResult<IEnumerable<Event>>(_events);

        public Task<Event> GetByIdAsync(Guid id) => Task.FromResult(_events.FirstOrDefault(e => e.Id == id));
