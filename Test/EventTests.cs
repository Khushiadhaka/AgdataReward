...
namespace Test
{
    public class EventTests
    {
        ...
        // Schedule a new event using a definition
        [Fact]
        ...
        // Create and complete an event instance
        [Fact]
        ...
        //Exception when completing non-existing event instance
        [Fact]
        ...
        //Exception when rescheduling non-existing event
        [Fact]
